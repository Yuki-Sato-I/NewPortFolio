    ...
    <HomeLayout title="佐藤裕紀のポートフォリオサイト">
      ...
      <div className="image">
        ...
        <div className="section">
          <SubTitle>関連URL <a href={workData[id].url} target='_blank' rel="noopener noreferrer" style={{color: CommonStyle.TextColor}}><Link style={{verticalAlign: 'top'}}/></a></SubTitle>
