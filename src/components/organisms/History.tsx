      ...
      <ul className="timeline">
        ...
        <li>
          ...
          <div className="timeline-content">
            ...
            <Text>
              ...
              東京で行われる1on1面談に2019-10頃まで毎月一回参加し,累計で50社以上の企業と面談をしてもらった.
            </Text>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-content">
            ...
            <Text>
              ...
              ・株式会社ネクストビート(ハッカソン)<br/>
              ・株式会社 侍(就業型)<br/>
              ・ソフトバンク株式会社(就業型)<br/>
              ・チームラボ(就業型)<br/>
              ・株式会社英チーム(ハッカソン)<br/>
              ある会社のインターンでは個人優秀賞に選ばれ, エンジニア・デザイナー・ビジネスの各職種から選抜された学生同士で参加する1ヶ月ハッカソンインターンに参加した.
            </Text>
          </div>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="timeline-content">
            ...
            <Text>
              iFive 代表に就任.以下が主な成果<br/>
              ・ネイティブアプリでの学生用シラバスの開発・運用(当時累計2,300インストール達成)<br/>
              ・広告プラットフォームの作成および受注達成<br/>
              ・留学生向けのアプリケーションの提案・及び開発<br/>
            </Text>
          </div>
        </li>
        <li>
